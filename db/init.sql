...
VALUES (
    ...
    1,
    1
  ), (2, 'Иван', 'Волик', 'Андреевич', '$2y$10$6EwftycFyoWTA2oxxLDTj.B5SIx.RF72uzNyoK3s4f6huyhXlfgvS', 'i.a.volik@gmail.com', '', b'1', 1);
...
INSERT INTO `Service` (`id`, `creatorId`, `name`, `workType`, `orderType`, `region`, `endDate`) VALUES 
(1, '1', 'Тестовая услуга', 1, 2, 1, '2022-05-12'),
(2, '2', 'Тестовая услуга 2', 2, 3, 2, '2022-05-12'), 
(3, '1', 'Тестовая услуга 3', 3, 4, 4, '2022-05-12'), 
(4, '2', 'Тестовая услуга 4', 1, 1, 3, '2022-05-12'), 
(5, '1', 'Тестовая услуга 5', 2, 3, 2, '2022-09-12'), 
(6, '2', 'Тестовая услуга 6', 3, 1, 1, '2022-04-12'), 
(7, '1', 'Тестовая услуга 7', 4, 2, 2, '2022-03-12'), 
(8, '1', 'Тестовая услуга 8', 3, 1, 1, '2022-02-12'), 
(9, '2', 'Тестовая услуга 9', 2, 4, 3, '2022-07-12');